...
public class BagelParser extends Parser {
	...
	public static final String[] tokenNames = {
		"<INVALID>", "' '", "';'", "'while'", "'.'", "DIGIT", "LETTER", "SYMBOL", 
		"'+'", "'-'", "'*'", "'/'", "COMPARISON_KEYWORDS", "'is'", "WHITESPACE", 
		"'if'", "'then'", "'else'", "'elif'", "'print'", "'{'", "'}'", "'('", 
	...
	public final Complex_expressionContext complex_expression() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(102); relational_expression();
			setState(109);
			_errHandler.sync(this);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					setState(104); match(LOGICAL_KEYWORDS);
					setState(105); match(T__3);
					setState(106); relational_expression();
					}
					} 
				}
				setState(111);
	...
	public final ConditionContext condition() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(112); complex_expression();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Return_statementContext return_statement() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(114); match(PRINT_KEYWORD);
	...
	public final While_loopContext while_loop() throws RecognitionException {
		...
		try {
			...
			setState(122); match(OPEN_BRACE);
			setState(123); match(T__3);
			setState(124); statements();
			setState(125); match(T__3);
			setState(126); match(CLOSE_BRACE);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final If_statementContext if_statement() throws RecognitionException {
		...
		try {
			...
			while (_la==T__3) {
				...
				setState(138); match(ELSEIF_KEYWORD);
				setState(139); match(T__3);
				setState(140); match(OPEN_BRACE);
				setState(141); match(T__3);
				setState(142); statements();
				setState(143); match(T__3);
				setState(144); match(CLOSE_BRACE);
				}
				}
				setState(150);
				_errHandler.sync(this);
	...
	public final Ifelse_statementContext ifelse_statement() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(159); if_statement();
			setState(161);
			_la = _input.LA(1);
			if (_la==ELSE_KEYWORD) {
				{
				setState(160); else_statement();
				}
			}
	...
	public final Construct_statementContext construct_statement() throws RecognitionException {
		...
		try {
			...
			case IF_KEYWORD:
				{
				setState(163); ifelse_statement();
				}
				break;
			case T__1:
				{
				setState(164); while_loop();
				}
				break;
			default:
	...
	public final Assignment_statementContext assignment_statement() throws RecognitionException {
		...
		try {
			...
			setState(171); match(ASSIGNMENT_KEYWORD);
			setState(173);
			_la = _input.LA(1);
			if (_la==T__3) {
				{
			...
			setState(175); complex_expression();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Other_statementContext other_statement() throws RecognitionException {
		...
		try {
			...
			case LETTER:
				{
				setState(177); assignment_statement();
				}
				break;
			case DATATYPE:
				{
				setState(178); declaration_statement();
				}
				break;
			case PRINT_KEYWORD:
				{
				setState(179); return_statement();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final StatementsContext statements() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__1) | (1L << LETTER) | (1L << IF_KEYWORD) | (1L << PRINT_KEYWORD) | (1L << DATATYPE))) != 0)) {
				{
				setState(184);
				switch (_input.LA(1)) {
				case T__1:
				case IF_KEYWORD:
					{
					setState(182); construct_statement();
					}
					break;
				case LETTER:
				case PRINT_KEYWORD:
	...
	public static final String _serializedATN =
		...
		"\r\u00c3\2,\3\2\2\2\4.\3\2\2\2\6\66\3\2\2\2\b>\3\2\2\2\nG\3\2\2\2\fI\3"+
		"\2\2\2\16P\3\2\2\2\20R\3\2\2\2\22a\3\2\2\2\24h\3\2\2\2\26r\3\2\2\2\30"+
		"t\3\2\2\2\32x\3\2\2\2\34\u0082\3\2\2\2\36\u0099\3\2\2\2 \u00a1\3\2\2\2"+
		"\"\u00a7\3\2\2\2$\u00a9\3\2\2\2&\u00b6\3\2\2\2(\u00bc\3\2\2\2*\u00c1\3"+
		"\2\2\2,-\t\2\2\2-\3\3\2\2\2.\62\7\b\2\2/\61\t\3\2\2\60/\3\2\2\2\61\64"+
		...
		"?@\3\2\2\2@A\7\7\2\2AC\7\6\2\2BD\7\7\2\2CB\3\2\2\2DE\3\2\2\2EC\3\2\2\2"+
		"EF\3\2\2\2F\t\3\2\2\2GH\t\5\2\2H\13\3\2\2\2IJ\7\34\2\2JK\7\3\2\2KL\5\4"+
		"\3\2L\r\3\2\2\2MQ\5\6\4\2NQ\5\b\5\2OQ\5\4\3\2PM\3\2\2\2PN\3\2\2\2PO\3"+
		"\2\2\2Q\17\3\2\2\2R^\5\16\b\2SU\7\3\2\2TS\3\2\2\2TU\3\2\2\2UV\3\2\2\2"+
